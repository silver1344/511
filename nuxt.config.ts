  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { name: 'twitter:title', content: '지환 ⚡ 택호 결혼합니다' },
        { name: 'twitter:description', content: '2026.05.17 SUN PM 1:00 | Powered by KEPCO E&C' },
        { name: 'twitter:image', content: 'https://silver1344.github.io/511/og-image.svg' }
      ],
      link: [
        { rel: 'preconnect', href: 'https://fonts.googleapis.com' },
        { rel: 'preconnect', href: 'https://fonts.gstatic.com', crossorigin: '' },
        { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Gowun+Batang:wght@400;700&family=IBM+Plex+Mono:wght@400;500;700&family=Noto+Sans+KR:wght@300;400;500;700&display=swap' }
      ]
    }
  },
